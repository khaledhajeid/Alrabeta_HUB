...
// Home split into a signed-in progress dashboard and a signed-out landing
// (docs/MASTER_PLAN.md's Phase 8.5 entry) — neither is "the platform's
// live cross-user feed," so that content gets its own route instead of
// competing with personal progress for the same page. The service-status
// footer moved with it: it's live operational state, the same theme as
// the feed above it, not personal-progress content.
